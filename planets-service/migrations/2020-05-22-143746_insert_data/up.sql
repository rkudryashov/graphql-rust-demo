insert into planets(name, planet_type) values ('Mercury', 'TerrestrialPlanet');
...
insert into planets(name, planet_type) values ('Venus', 'TerrestrialPlanet');
...
insert into planets(name, planet_type) values ('Earth', 'TerrestrialPlanet');
...
insert into planets(name, planet_type) values ('Mars', 'TerrestrialPlanet');
...
insert into planets(name, planet_type) values ('Jupiter', 'GasGiant');
...
insert into planets(name, planet_type) values ('Saturn', 'GasGiant');
...
insert into planets(name, planet_type) values ('Uranus', 'IceGiant');
...
insert into planets(name, planet_type) values ('Neptune', 'IceGiant');
